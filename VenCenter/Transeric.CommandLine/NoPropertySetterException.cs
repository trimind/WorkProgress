...
namespace Transeric.CommandLine
{
	...
	/// </summary>
	[Serializable]
	public class NoPropertySetterException : CommandLinePropertyException
	{
		#region Constructors
		/// <summary>
		...
		/// </exception>
		public NoPropertySetterException(string propertyName)
		...
		/// <paramref name="propertyName"/> is null
		/// </exception>
		public NoPropertySetterException(string propertyName, string message)
		...
		/// <paramref name="propertyName"/> is null
		/// </exception>
		public NoPropertySetterException(string propertyName, string message, Exception innerException)
			: base(propertyName, message ?? string.Format(Resources.NoPropertySetterException_Format,
		...
		public NoPropertySetterException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
