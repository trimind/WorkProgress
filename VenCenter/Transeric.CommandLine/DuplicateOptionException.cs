...
{
	/// <summary>
	/// This exception occurs when the same option appears multiple times on a command line.
	/// </summary>
	[Serializable]
	public class DuplicateOptionException : CommandLineOptionException
	{
		#region Constructors
		/// <summary>
		...
		/// <paramref name="optionName"/> is null
		/// </exception>
		public DuplicateOptionException(string optionName, string message)
		...
		/// <paramref name="optionName"/> is null
		/// </exception>
		public DuplicateOptionException(string optionName, string message, Exception innerException)
			: base(optionName, message ?? string.Format(Resources.DuplicateOptionException_Format,
		...
		public DuplicateOptionException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
